...
//        [statusWindow makeKeyAndVisible];
        ...
        _tipContent.text = [NSString stringWithFormat:@"RDP: http://%@:10911 (use Chrome/Safari)",IPString];
        
        double delayInSeconds = 60.0*60;
    ...
    BOOL testStartorNot = [super start];
    NSLog(@" test test %d",testStartorNot);

    return testStartorNot;
}
